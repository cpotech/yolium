...
Use `claude`, `codex`, or `opencode` as the provider. Use the concrete model identifier you recognise yourself as. This must be emitted before Phase 1 — no discovery or other step output may precede it.
