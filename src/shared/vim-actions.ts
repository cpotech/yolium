...
export const VIM_ACTIONS: VimAction[] = [
  ...
  { id: 'kanban-project-1', key: '1', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 1' },
  { id: 'kanban-project-2', key: '2', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 2' },
  { id: 'kanban-project-3', key: '3', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 3' },
  { id: 'kanban-project-4', key: '4', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 4' },
  { id: 'kanban-project-5', key: '5', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 5' },
  { id: 'kanban-project-6', key: '6', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 6' },
  { id: 'kanban-project-7', key: '7', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 7' },
  { id: 'kanban-project-8', key: '8', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 8' },
  { id: 'kanban-project-9', key: '9', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 9' },
  { id: 'kanban-project-10', key: '0', zone: 'content', mode: 'NORMAL', category: 'vim', group: 'Content (Kanban)', description: 'Select project 10' },
