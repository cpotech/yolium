...
export const VIM_ACTIONS: VimAction[] = [
  ...
  { id: 'kanban-project-1', key: '1', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 1' },
  { id: 'kanban-project-2', key: '2', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 2' },
  { id: 'kanban-project-3', key: '3', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 3' },
  { id: 'kanban-project-4', key: '4', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 4' },
  { id: 'kanban-project-5', key: '5', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 5' },
  { id: 'kanban-project-6', key: '6', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 6' },
  { id: 'kanban-project-7', key: '7', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 7' },
  { id: 'kanban-project-8', key: '8', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 8' },
  { id: 'kanban-project-9', key: '9', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 9' },
  { id: 'kanban-project-10', key: '0', zone: 'global', mode: 'NORMAL', category: 'vim', group: 'Tab Selection', description: 'Select tab 10' },
  ...
  { id: 'specialist-toggle', key: 'd', zone: 'schedule', mode: 'NORMAL', category: 'vim', group: 'Schedule (Agents)', description: 'Toggle enabled' },
  { id: 'specialist-history', key: 'Enter', zone: 'schedule', mode: 'NORMAL', category: 'vim', group: 'Schedule (Agents)', description: 'Open history' },
  { id: 'specialist-configure', key: 'o', zone: 'schedule', mode: 'NORMAL', category: 'vim', group: 'Schedule (Agents)', description: 'Configure specialist' },
  ...
  // --- Dialog sidebar — direct shortcuts + Ctrl+N agent dispatch ---
  { id: 'agent-1-sidebar', key: 'Ctrl+1', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 1 (by order)' },
  { id: 'agent-2-sidebar', key: 'Ctrl+2', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 2 (by order)' },
  { id: 'agent-3-sidebar', key: 'Ctrl+3', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 3 (by order)' },
  { id: 'agent-4-sidebar', key: 'Ctrl+4', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 4 (by order)' },
  { id: 'agent-5-sidebar', key: 'Ctrl+5', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 5 (by order)' },
  { id: 'agent-6-sidebar', key: 'Ctrl+6', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 6 (by order)' },
  { id: 'agent-7-sidebar', key: 'Ctrl+7', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 7 (by order)' },
  { id: 'agent-8-sidebar', key: 'Ctrl+8', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 8 (by order)' },
  { id: 'agent-9-sidebar', key: 'Ctrl+9', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Agent 9 (by order)' },
  ...
  { id: 'dialog-check-conflicts', key: 'c', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Check Conflicts' },
  { id: 'dialog-merge-locally', key: 'm', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Merge Locally' },
  { id: 'dialog-merge-push-pr', key: 'M', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Squash, Merge & Push PR' },
  ...
  { id: 'toggle-verified-sidebar', key: 'p', zone: 'dialog-sidebar', mode: 'NORMAL', category: 'vim', group: 'Sidebar Focus (Work Item)', description: 'Toggle Verified (sidebar)' },
